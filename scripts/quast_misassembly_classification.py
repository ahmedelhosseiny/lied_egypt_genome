...
def read_quast_file(file):
    ...
    with open(file) as f:
        ...
        for line in f:
            ...
            #splits = line.split('\t') # IW -> fixed this to next line
            splits = line.split(' ')
...
if __name__ == '__main__':
    ...
    centromeres_and_segdups_and_svs = centromeres + segdups + svs
    ...
    count_misassemblies_not_overlapping_with_svs(centromeres_and_segdups_and_svs, m_assemblies)