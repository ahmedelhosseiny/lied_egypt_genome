...
snakemake -k -j 36 --resources io=4 --use-conda --jobname "{jobid}.{rulename}.sh" --cluster "sbatch --mem 16G --partition=longterm --time 7-00:00:00 -c 4 -o log/%j.{rule}.log" --printshellcmds dotplots_scaffold_vs_chromosomes_all #run_repeatmasker_chromosomewise #run_busco_chromosomewise
