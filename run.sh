...
snakemake --reason --rerun-incomplete -k -j 16 --resources io=4 --use-conda --jobname "{jobid}.{rulename}.sh" --cluster "sbatch --mem 12G --partition=longterm --time 7-00:00:00 -c 2 -o log/%j.{rule}.log" --printshellcmds illumina_bamstats_all #align_mummer_GRCh38_vs_CEGYPTREF/assemblies/GRCh38_vs_CEGYPTREF.delta
