...
snakemake -n -k -j 48 --resources io=4 --use-conda --jobname "{jobid}.{rulename}.sh" --cluster "sbatch --mem 16G --partition=longterm --time 2-00:00:00 -c 4 -o log/%j.{rule}.log" --printshellcmds align_all_vs_all_mummer
