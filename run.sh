...
snakemake --rerun-incomplete -k -j 16 --resources io=4 --use-conda --jobname "{jobid}.{rulename}.sh" --cluster "sbatch --mem 80G --partition=longterm --time 5-00:00:00 -c 24 -o log/%j.{rule}.log" --printshellcmds  vc_joint_genotyping_all # results/repeatmasker_comparison.txt
