...
snakemake -p -k -j 10 --rerun-incomplete -s Snakefile_assembly --use-conda --jobname "{jobid}.{rulename}.sh" --cluster "sbatch --mem 170G --partition=shortterm,longterm --time 3-00:00:00 -c 48 -o log/%j.{rule}.log" bwa_mapping_10x_against_grch38_all_libs
