...
snakemake -n -p -k -j 5 --rerun-incomplete --use-conda --jobname "{jobid}.{rulename}.sh" --cluster "sbatch --mem 32G --partition=shortterm,longterm --time 3-00:00:00 -c 2 -o log/%j.{rule}.log" gc_get_mapped_egyptref_reads_all
