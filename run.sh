...
snakemake --reason --rerun-incomplete -k -j 12 --resources io=4 --use-conda --jobname "{jobid}.{rulename}.sh" --cluster "sbatch --mem 16G --partition=longterm --time 7-00:00:00 -c 2 -o log/%j.{rule}.log" --printshellcmds gc_get_mapped_egyptref_reads_all gc_get_variants_all # results/repeatmasker_comparison.txt
